...
class EventNavigation @Inject constructor(val activity: AppCompatActivity,
    ...
    override fun navigateShare(data: EventItem) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, data.name + " (" + activity.getString(R.string.app_name) + ")")
        intent.putExtra(Intent.EXTRA_TEXT, shareBody)
        intent.setType("text/plain");
        startActivity(activity, Intent.createChooser(intent, activity.getString(R.string.send_to, data.type!!)), null)
    }
