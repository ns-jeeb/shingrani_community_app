...
class AnnouncementCreateFragment : Fragment() {
    ...
    private lateinit var binding: ActivityCreateAnnouncementBinding // todo rename

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.activity_create_announcement, container, false)
        setupViews()
        return binding.root
    }
